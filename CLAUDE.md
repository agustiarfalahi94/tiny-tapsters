...
- **Tiny Tapsters**: Flutter toddler-games app (`com.inkpebble.tiny_tapsters`), **v1.18.4+41**, Flutter 3.41.6 (stable), Android-first, emoji-based graphics (no image assets).
