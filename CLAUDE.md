...
- **Tiny Tapsters**: Flutter toddler-games app (`com.inkpebble.tiny_tapsters`), **v1.19.0+42**, Flutter 3.41.6 (stable), Android-first, emoji-based graphics (no image assets).
