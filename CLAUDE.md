...
- **Validation before any commit:** `flutter analyze` (0 issues), `dart format --set-exit-if-changed lib/ test/`, `flutter test` (**16/16**), `flutter build apk --release` (when native config or deps change).
