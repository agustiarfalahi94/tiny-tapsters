...
- Do NOT add permissions, ads, analytics, or network code — the app must stay offline and permission-free.
...
- `test/widget_test.dart` — home screen, all-screens-build smoke test, Find It! tint regression.
