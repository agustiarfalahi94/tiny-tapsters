...
Tiny Tapsters — Flutter toddler-games app (`com.inkpebble.tiny_tapsters`). v1.21.4+48 · Flutter 3.41.6 · Android-first · Emoji-based graphics (no image assets; bundled audio only: `assets/sfx/*` and `assets/music/*`) · Shared signing keystore with the `random_recall` project.
