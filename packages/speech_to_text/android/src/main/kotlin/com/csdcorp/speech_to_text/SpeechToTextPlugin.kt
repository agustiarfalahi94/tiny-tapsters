            ...
            handler.post {
                run {
                    recognizerIntent = Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH).apply {
                        ...
                        // Without these two, Android ends a session after its
                        // own ~500ms "probably finished" guess, which is
                        // shorter than the pause between words in a sentence.
                        possiblyCompleteSilence?.also {
